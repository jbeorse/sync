...
public class SyncActivity extends Activity {
	...
	AlertDialog.Builder buildOkMessage(String title, String message) {
	   ...
	   * @return
	   */
	  private static String getMessageForTableResult(Context context,
	      TableResult result) {
       ...
       msg.append(
	    ...
	    case SUCCESS:
	      ...
	      break;
	    default:
	      Log.e(LOGTAG, "unrecognized TableResult status: " + status + ". Setting " +
	            "to failure.");
	      name = context.getString(R.string.sync_table_result_failure);
	    }
	...
	AlertDialog.Builder buildResultMessage(String title,
		...
		for (int i = 0; i < result.getTableResults().size(); i++) {
			...
			stringBuilder.append(getMessageForTableResult(this,
					tableResult));
