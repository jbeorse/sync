...
public class AppSynchronizer {
	...
	AppSynchronizer(Service context, String appName,
	...
	private class SyncTask implements Runnable {
		...
		public void run() {
			try {
				...
				notificationManager.startingSync(appName);
				...
				String versionCode = SyncApp.getInstance()
						.getVersionCodeString();
				...
				Synchronizer synchronizer = new AggregateSynchronizer(appName,
						odkClientVersion, prefs.getServerUri(),
						prefs.getAuthToken());
				...
				SynchronizationResult configResults = processor
						.synchronizeConfigurationAndContent(push);
				// examine results
				...
				SynchronizationResult dataResults = processor
						.synchronizeDataRowsAndAttachments();
				...
				notificationManager.stopingSync(appName);
